...
describe('greet', () => {
  ...
  test('should handle names with spaces, hyphens, and apostrophes', () => {
    expect(greet('Mary Jane')).toBe(
      'Hello, Mary Jane! Welcome to Project Template'
    );
    expect(greet('Jean-Paul')).toBe(
      'Hello, Jean-Paul! Welcome to Project Template'
    );
    expect(greet("O'Connor")).toBe(
      "Hello, O'Connor! Welcome to Project Template"
    );
  });
...
describe('loadConfiguration', () => {
  ...
  test.each([
    ...
    'should return default config for invalid env vars: %s',
