...
class TestConfiguration(unittest.TestCase):
    ...
    def test_load_configuration_dotenv_import_error(self, mock_load_dotenv, mock_exists):
    ...
    def test_validate_config_invalid_semantic_version(self):
        ...
        invalid_versions = [
            '1', '1.0', '1.0.0.0', '1.0.0-beta', 'v1.0.0', '1.0.0a'
        ]
    ...
    def test_validate_config_valid_semantic_versions(self):
        ...
        valid_versions = [
            '0.0.1', '1.0.0', '2.1.3', '10.20.30', '1.0.0', '999.999.999'
        ]
...
class TestIntegration(unittest.TestCase):
    ...
    def test_full_application_flow_with_typer(
        self, _mock_exit, _mock_get_logger, _mock_load_dotenv, _mock_exists
    ):
    ...
    @patch('main.Path.exists', return_value=False)
    @patch('main.logging.getLogger')
    def test_application_runs_with_default_config(
        self, mock_get_logger, _mock_exists
    ):
