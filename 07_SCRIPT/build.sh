...
load_configuration() {
    ...
    local config_file="06_CONFIG/build.config"
...
copy_assets() {
    local asset_dirs=("05_ASSETS" "assets" "public" "static")
...
main() {
    ...
    echo ""
    echo "Next steps:"
    echo "• Run deployment: ./07_SCRIPT/deploy.sh [environment]"
    echo "• Run tests: ./07_SCRIPT/test-env.sh"
}
